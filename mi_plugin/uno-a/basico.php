 ...
 */
    ...
    function uno_a_remove_menus () 
    {
        ...
        while (prev($menu))
        {
         ...
         <style>
		#toplevel_page_wpfastestcacheoptions,#toplevel_page_Wordfence,#toplevel_page_betheme,#toplevel_page_revslider,#toplevel_page_duplicator,#toplevel_page_vc-general,#toplevel_page_wpcf7{
		display: none;
		}
